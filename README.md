...
The dynamics of vanilla NODE are given as 

<p align="center">
<img src="https://render.githubusercontent.com/render/math?math={\color{white} \xi(0) = \tanh(W_0 {x} %2B b_0) }"/>
</p>

<p align="center">
<img src="https://render.githubusercontent.com/render/math?math={\color{white} \dot{\xi}(t) = \tanh(W {\xi}(t) %2B b) }"/>
</p> 

<p align="center">
<img src="https://render.githubusercontent.com/render/math?math={\color{white}  y(T) = \tanh(W_T {\xi}(T) %2B b_T) }"/>
</p>
